...
<html class="no-js" lang="en">
    <head>
        ...
        <title>User Profile - Công Ty Gia Truyền Hồng Đức</title>
                    ...
                    <div class="profile-container">
                        ...
                        <div style="background-color: #f8f9fa; padding: 10px; margin-bottom: 15px; border-radius: 4px;">
                            ...
                            <c:if test="${sessionScope.acc != null}">
                                <p>Username: ${sessionScope.acc.user}</p>
                        ...
                        <c:if test="${sessionScope.acc != null}">
                            <form action="updateProfile" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="username" name="username" class="form-control" value="${sessionScope.acc.user}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control" value="${sessionScope.acc.phone}">
